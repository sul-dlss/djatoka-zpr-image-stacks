var zpr = function(viewFinderId, inputValues) {
  ...
  var addControlElements = function() {
    ...
    viewFinder
    .append($('<div>', { 'class': 'zpr-controls' })
      .append('<a href="#" id="' + viewFinderId + '-zoom-in"><img src="images/zpr-zoom-in.png" width="16" height="16""></a>')
      .append('<a href="#" id="' + viewFinderId + '-zoom-out"><img src="images/zpr-zoom-out.png" width="16" height="16""></a>')
      .append('<a href="#" id="' + viewFinderId + '-rotate-cw"><img src="images/zpr-rotate-cw.png" width="16" height="16""></a>')
      .append('<a href="#" id="' + viewFinderId + '-rotate-ccw"><img src="images/zpr-rotate-ccw.png" width="16" height="16""></a>')
    );

    $('#' + viewFinderId + '-zoom-in').click(function(){ zoom('in'); });
    $('#' + viewFinderId + '-zoom-out').click(function(){ zoom('out'); });
    $('#' + viewFinderId + '-rotate-cw').click(function(){ rotate('cw'); });
    $('#' + viewFinderId + '-rotate-ccw').click(function(){ rotate('ccw'); });
  ...
  var getLevels = function() {
    ...
    //var level = Math.round(Math.log(longestSide) / Math.log(2)) - Math.round(Math.log(92) / Math.log(2)) - 1;
    return level;
  };
  ...
  var zoom = function(direction) {
    ...
    switch (direction) {
      case 'in': 
        newLevel = clampLevel(newLevel + 1); 
        break;
  ...
  var setupMarquee = function() {
    var level = clampLevel(getLevelForContainer(settings.marqueeImgSize) + 1);
